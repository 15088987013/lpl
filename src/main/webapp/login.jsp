    ...
    <script type="text/javascript" >
        $(function () {
            ...
            $("#btn").click(function () {
                ...
                // alert(data)
                // 发送ajax请求
                $.post("/lplsystem/serve/UserServlet?method=login",data,function (result) {
                    if(result == 1){
    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>LPL战队管理系统</h1></div>
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img src="/lplsystem/vcs" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">
